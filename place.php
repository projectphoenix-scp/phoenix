...
<br><br>Aim: Contain SCPs and expand building to house more.</div>
 ...
 <div class="drop" id='big1'>
  ...
  <div style='float:right;position:relative;bottom:410px;right:13px;'>
  <form action="set.php" name='set' id='set' method="post">
	<input type="submit" value="" style="position:relative;left:8px;background:url('pics/update.png');width:18px;background-size:18px;border:none;cursor:pointer;">
	<br><input type="submit" onclick="document.getElementById('wy').value = '';document.getElementById('ex').value = '';document.getElementById('nam').value = '';" value="" style="background:url('pics/x.png');width:35px;height:25px;;background-size:35px;border:none;cursor:pointer;"><br>
...
<ul id="sortable">
 <!-- <li class="ui-state-default" style='width:800px;height:600px;'>1</li>-->
  <li class="ui-state-default" style='width:480px;height:320px;'>
  
<center>  LAYOUT | <a href='assign.php'>ASSIGN</a></center>
